...
\input{content_se/work-exp}

\vspace{1em}

\input{content_se/volunteering-exp}
...
\begin{minipage}[t]{\rightcolwidth}
    ...
    \input{content_se/education}

    \input{content_se/skills}

\end{minipage}

\vspace{1em}

\input{content_se/projects}
