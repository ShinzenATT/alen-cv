...
\begin{tabular}{>{\footnotesize\bfseries} p{32pt} >{\footnotesize}p{0.35\textwidth}}
    ...
    Targeting multiple platforms with Transport Planner website and mobile app for drivers and construction site managers for handling and tracking deliveries made in React Native and React with Next.js.
   ...
   % PubF & System Adminstration such as migrating services to Google Workspace, configuring DNS and improving booking system made in Laravel PHP and Vue.js. \vspace{3px} \\
    ...
    Worked with User Experience (UX) and Requirements Engineering (RE) in university.
